...
import moment from 'moment-timezone'
 ...
 let fload = {
    ...
    message: `${ucapan()}`,
    orderTitle: `${ucapan()}`,
    thumbnail:   await (await fetch(`https://telegra.ph/file/337794671f66c0e6d12f1.jpg`)).buffer(),
 ...
                   "rows": [{ 
                     "title": `Pemilik Bot`, 
                     "description": "Nomor Pemilik Bot (Creator)", 
 ...
                       "description": "Masukkan bot ke dalam group tanpa batasan waktu!", 
                       "rowId": ".masuk"
                   }], 
                     "title": "───────「 Permanent 」" 
                 } 
...
➠ Pembayaran saat ini hanya tersedia via dana dan gopay
.
