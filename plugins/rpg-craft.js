...
const sections = [
   {
	title: "CRAFT A TOOLS",
	rows: [
	    {title: "SWORD ⚔️", rowId: ".craft sword", description: "Buat sword"},
	    {title: "PICKAXE ⛏️", rowId: ".craft pickaxe", description: "Buat pickaxe"},
	    {title: "FISHINGROD 🎣", rowId: ".craft fishingrod", description: "Buat pancingan"},
	    {title: "ARMOR 🥼", rowId: ".craft armor", description: "Buat Armor"},
	    {title: "ATM 💳", rowId: ".craft atm", description: "Membuat Atm (Ilegal)"},
	]
    },
]
